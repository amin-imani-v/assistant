...
echo "##### Downloading the latest version of prometheus #####"
mkdir -p /tmp/prometheus && cd /tmp/prometheus
curl -s https://api.github.com/repos/prometheus/prometheus/releases/latest|grep browser_download_url|grep linux-amd64|cut -d '"' -f 4|wget -qi -

echo "##### Extracting prometheus files and put in their directory #####"
...
echo "##### Create/Edit a Prometheus configuration file #####"
...
echo "##### Creating a Prometheus systemd Service unit file #####"
tee /etc/systemd/system/prometheus.service<<EOF
[Unit]
Description=Prometheus written by AMIN IMANI
